      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center py-16">
          ...
          <button
            ...
            className="bg-delivery-primary text-white px-6 py-3 rounded-full hover:bg-delivery-dark transition-all duration-200 font-medium"
          >
            Browse Menu
          </button>
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <button
          onClick={onCheckout}
          className="w-full bg-delivery-primary text-white py-4 rounded-xl hover:bg-delivery-dark transition-all duration-200 transform hover:scale-[1.02] font-medium text-lg shadow-lg"
        >
          Proceed to Checkout
        </button>
      </div>
